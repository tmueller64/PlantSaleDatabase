...
dojo.provide("dojo.widget.DataShow");
dojo.provide("dojo.widget.html.DataShow");
...
dojo.widget.html.DataShow = function(){
	dojo.widget.HtmlWidget.call(this);

	this.templatePath = dojo.uri.dojoUri("src/plantsale/templates/HtmlDataShow.html");
	this.templateCssPath = dojo.uri.dojoUri("src/plantsale/templates/HtmlDataShow.css");

	// over-ride some defaults
	this.isContainer = false;
	this.widgetType = "DataShow";
...
dojo.inherits(dojo.widget.html.DataShow, dojo.widget.HtmlWidget);
dojo.widget.tags.addParseTreeHandler("dojo:datashow");
