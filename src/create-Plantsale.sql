...
insert into saleproduct values (1, 1, "Mums", 1, 2.00, 0.3);
insert into saleproduct values (2, 1, "Lillies", 2, 3.00, 0.3);
insert into saleproduct values (4, 1, "Tree", 3, 10.00, 0.3);
insert into saleproduct values (3, 2, "Better Mums", 1, 2.50, 0.3);
